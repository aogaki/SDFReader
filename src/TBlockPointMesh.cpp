...
{
  cout << "Normalization factor: " << fNormFactor[0] << "\t" << fNormFactor[1]
       << "\t" << fNormFactor[2] << endl;
  cout << "Axis label: " << fAxisLabel[0] << "\t" << fAxisLabel[1] << "\t"
       << fAxisLabel[2] << endl;
  cout << "Units: " << fUnits[0] << "\t" << fUnits[1] << "\t" << fUnits[2]
       << endl;
  cout << "Geometry type: " << fGeoType << endl;
  cout << "Min value: " << fMinVal[0] << "\t" << fMinVal[1] << "\t"
       << fMinVal[2] << endl;
  cout << "Max value: " << fMaxVal[0] << "\t" << fMaxVal[1] << "\t"
       << fMaxVal[2] << endl;
  cout << "No. Particles: " << fNParticles << endl;
}

void TBlockPointMesh::ReadData() {}  // Do nothing
